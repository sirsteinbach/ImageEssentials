          ...
          <ul>
            <li>
              <div class="slide-body" data-group="slide"><img src="img/slider/1_Veil.jpg" nopin="nopin" />
                ...
                <div class="caption s1_p4 hide-for-small" data-animate="slideAppearRightToLeft" data-delay="900" data-length="800">Makeover</div>
              </div>
            </li>
            <li>
              <div class="slide-body" data-group="slide"><img src="img/slider/2_Ariana.jpg" nopin="nopin">
                ...
                <div class="caption s2_p5 hide-for-small" data-animate="slideAppearRightToLeft" data-delay="900" data-length="800">Dramatic</div>
              </div>
            </li>
            <li>
            ...
            <li>
              <div class="slide-body" data-group="slide"><img src="img/slider/4_Snow.jpg" nopin="nopin" />
                ...
                <div class="caption s4_p4 hide-for-small" data-animate="slideAppearLeftToRight" data-delay="400" data-length="500">Absolute</div>
              </div>
            </li>
            <li>
            ...
            <li>
              <div class="slide-body" data-group="slide"><img src="img/slider/7_Katrina.jpg" nopin="nopin" />
                ...
                <div class="caption s7_p4 hide-for-small" data-animate="slideAppearLeftToRight" data-delay="400" data-length="500">Bridal</div>
              </div>
            </li>
            <li>
    ...
    <div class="medium-12 columns MakeupClr4">
      ...
      <div class="row" data-equalizer>
        ...
        <div class="medium-4 columns">
          <div class="panel radius">
            <h5 class="panel-head bgPinkLt">
            <span class="fa-stack fa-lg"><i class="fa fa-circle fa-stack-2x BlueDk"></i><i class="fa fa-phone fa-stack-1x fa-inverse"></i></span> Contact</h5>
            <p data-equalizer-watch>Please don't hesitate to get in touch with me if you wish to make a booking or set up a meeting. It's easy to do, and I'd be happy to respond right away... [<a href="contact.php"><small>MORE</small></a>]</p>
            <a href="contact.php" class="button tiny radius">MORE &nbsp;<i class="fa fa-angle-double-right fa-lg"></i></a>
          </div>
        </div>
      </div>
